...
for ( $i = 1; $i <= 5; $i++ ) {
	...
	$wp_customize->add_setting(
		'blueplanet_options[main_slider_block_message_' . $i . ']',
		array(
			'default'              => '',
			'capability'           => 'edit_theme_options',
	...
	$wp_customize->add_control(
		new Blue_Planet_Customize_Heading_Control(
			$wp_customize,
			'blueplanet_options[main_slider_block_message_' . $i . ']',
			array(
	...
	$wp_customize->add_setting(
		'blueplanet_options[main_slider_image_' . $i . ']',
		array(
			'default'              => '',
			'capability'           => 'edit_theme_options',
...
$wp_customize->add_control(
	new Blue_Planet_Customize_Dropdown_Taxonomies_Control(
		$wp_customize,
		'blueplanet_options[slider_category_2]',
		array(
